...
You develop and commit your changes in a clone of our upstream repository (shown as _local_ in the image above).
Then you push your changes to your forked repository (_origin_) and send us a pull request.
Eventually, we will merge your pull request back into the _upstream_ repository.
