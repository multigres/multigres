...
// TestMultiOrchMixedInitializationRepair tests multiorch handling of mixed scenarios
// where some nodes are initialized and others are not. After primary failure, multiorch
// should prefer promoting the initialized standby over bootstrapping uninitialized nodes.
