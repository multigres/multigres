...
// Package pgproto runs Tatsuo Ishii's pgproto wire-protocol conformance tool
// against two targets (a standalone PostgreSQL and a Multigres multigateway)
// and records where the multigateway's response trace diverges from
// PostgreSQL's. See the package README for rationale, the data-file format,
// and how to expand the corpus.
package pgproto
