...
func TestWatchTopoVersion(t *testing.T) {
	...
	var data <-chan *topoclient.WatchData
	...
	// the key's topoclient.Version to be 2 as it's the second change to the keyspace.
...
func TestWatchRecursiveReconnection(t *testing.T) {
	...
	require.Eventually(t, func() bool {
		return checkPortAvailable(clientPort) == nil && checkPortAvailable(peerPort) == nil
