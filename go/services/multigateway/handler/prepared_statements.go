...
// Conformance is asserted so a method rename breaks the build instead of
// silently disabling alias reconciliation at the call sites' type assertions.
var _ server.PreparedStatementAliasProvider = (*MultigatewayHandler)(nil)
