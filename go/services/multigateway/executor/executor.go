...
// Parse inside an explicit transaction. The carrier is the StreamExecute
// reservation path with eager_parse_prepared_statement set; the multipooler
// runs an unnamed Parse after replaying any deferred BEGIN.
