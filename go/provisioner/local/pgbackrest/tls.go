...
// GenerateServerCert generates a server certificate signed by the CA for pgBackRest TLS server.
// The nodeName is used as the certificate's Common Name for identification.
func GenerateServerCert(caCertPath, caKeyPath, certPath, keyPath, nodeName string) error {
