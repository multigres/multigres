...
var file_pgctldservice_proto_goTypes = []any{
	...
	(*CrashRecoveryRequest)(nil),  // 19: pgctldservice.CrashRecoveryRequest
	(*CrashRecoveryResponse)(nil), // 20: pgctldservice.CrashRecoveryResponse
	(*durationpb.Duration)(nil),   // 21: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil), // 22: google.protobuf.Timestamp
}
var file_pgctldservice_proto_depIdxs = []int32{
	21, // 0: pgctldservice.StopRequest.timeout:type_name -> google.protobuf.Duration
	21, // 1: pgctldservice.RestartRequest.timeout:type_name -> google.protobuf.Duration
	0,  // 2: pgctldservice.StatusResponse.status:type_name -> pgctldservice.ServerStatus
	21, // 3: pgctldservice.StatusResponse.uptime:type_name -> google.protobuf.Duration
	12, // 4: pgctldservice.StatusResponse.pgbackrest_status:type_name -> pgctldservice.PgBackRestStatus
	22, // 5: pgctldservice.PgBackRestStatus.last_started:type_name -> google.protobuf.Timestamp
	1,  // 6: pgctldservice.CrashRecoveryResponse.state_before:type_name -> pgctldservice.DatabaseClusterState
	1,  // 7: pgctldservice.CrashRecoveryResponse.state_after:type_name -> pgctldservice.DatabaseClusterState
	2,  // 8: pgctldservice.PgCtld.Start:input_type -> pgctldservice.StartRequest
	4,  // 9: pgctldservice.PgCtld.Stop:input_type -> pgctldservice.StopRequest
	6,  // 10: pgctldservice.PgCtld.Restart:input_type -> pgctldservice.RestartRequest
	8,  // 11: pgctldservice.PgCtld.ReloadConfig:input_type -> pgctldservice.ReloadConfigRequest
	10, // 12: pgctldservice.PgCtld.Status:input_type -> pgctldservice.StatusRequest
	13, // 13: pgctldservice.PgCtld.Version:input_type -> pgctldservice.VersionRequest
	15, // 14: pgctldservice.PgCtld.InitDataDir:input_type -> pgctldservice.InitDataDirRequest
	17, // 15: pgctldservice.PgCtld.PgRewind:input_type -> pgctldservice.PgRewindRequest
	19, // 16: pgctldservice.PgCtld.CrashRecovery:input_type -> pgctldservice.CrashRecoveryRequest
	3,  // 17: pgctldservice.PgCtld.Start:output_type -> pgctldservice.StartResponse
	5,  // 18: pgctldservice.PgCtld.Stop:output_type -> pgctldservice.StopResponse
	7,  // 19: pgctldservice.PgCtld.Restart:output_type -> pgctldservice.RestartResponse
	9,  // 20: pgctldservice.PgCtld.ReloadConfig:output_type -> pgctldservice.ReloadConfigResponse
	11, // 21: pgctldservice.PgCtld.Status:output_type -> pgctldservice.StatusResponse
	14, // 22: pgctldservice.PgCtld.Version:output_type -> pgctldservice.VersionResponse
	16, // 23: pgctldservice.PgCtld.InitDataDir:output_type -> pgctldservice.InitDataDirResponse
	18, // 24: pgctldservice.PgCtld.PgRewind:output_type -> pgctldservice.PgRewindResponse
	20, // 25: pgctldservice.PgCtld.CrashRecovery:output_type -> pgctldservice.CrashRecoveryResponse
