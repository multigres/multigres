...
type ExecuteOptions struct {
	...
	PreparedStatementAliases []*PreparedStatementAlias `protobuf:"bytes,9,rep,name=prepared_statement_aliases,json=preparedStatementAliases,proto3" json:"prepared_statement_aliases,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
const file_query_proto_rawDesc = "" +
	...
	"\x12backend_process_id\x18\x04 \x01(\rR\x10backendProcessId\"\xdf\x04\n" +
	...
	"\x0fpassthrough_row\x18\b \x01(\bR\x0epassthroughRow\x12[\n" +
	"\x1aprepared_statement_aliases\x18\t \x03(\v2\x1d.query.PreparedStatementAliasR\x18preparedStatementAliases\x1aB\n" +
...
var file_query_proto_depIdxs = []int32{
	...
	21, // 13: query.ReservedState.pooler_id:type_name -> clustermetadata.ID
	...
	11, // 17: query.ExecuteOptions.prepared_statement_aliases:type_name -> query.PreparedStatementAlias
