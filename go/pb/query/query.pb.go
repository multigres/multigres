...
var file_query_proto_depIdxs = []int32{
	...
	4,  // 5: query.QueryResult.notices:type_name -> query.PgDiagnostic
	7,  // 6: query.StatementDescription.parameters:type_name -> query.ParameterDescription
	2,  // 7: query.StatementDescription.fields:type_name -> query.Field
	16, // 8: query.Target.pooler_type:type_name -> clustermetadata.PoolerType
	17, // 9: query.ReservedState.pooler_id:type_name -> clustermetadata.ID
	15, // 10: query.ExecuteOptions.session_settings:type_name -> query.ExecuteOptions.SessionSettingsEntry
	9,  // 11: query.ExecuteOptions.prepared_statement:type_name -> query.PreparedStatement
	13, // 12: query.ExecuteOptions.user_auth:type_name -> query.UserAuth
