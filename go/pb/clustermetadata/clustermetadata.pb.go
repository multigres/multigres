...
const file_clustermetadata_proto_rawDesc = "" +
	...
	"\aRESTORE\x10\x03*\xa5\x01\n" +
	"\n" +
	"QuorumType\x12\x17\n" +
	"\x13QUORUM_TYPE_UNKNOWN\x10\x00\x12\x1a\n" +
	"\x16QUORUM_TYPE_AT_LEAST_N\x10\x03\x12%\n" +
	"!QUORUM_TYPE_MULTI_CELL_AT_LEAST_N\x10\x04\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02*\x11QUORUM_TYPE_ANY_N*\x1cQUORUM_TYPE_MULTI_CELL_ANY_N*\xa2\x01\n" +
