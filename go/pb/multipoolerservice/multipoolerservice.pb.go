...
type PrimaryObservation struct {
	...
	VotingTerm    int64 `protobuf:"varint,2,opt,name=voting_term,json=votingTerm,proto3" json:"voting_term,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PrimaryObservation) GetVotingTerm() int64 {
	if x != nil {
		return x.VotingTerm
	}
	return 0
...
const file_multipoolerservice_proto_rawDesc = "" +
	...
	"\x1drecommended_staleness_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x1brecommendedStalenessTimeout\"i\n" +
	"\x12PrimaryObservation\x122\n" +
	"\n" +
	"primary_id\x18\x01 \x01(\v2\x13.clustermetadata.IDR\tprimaryId\x12\x1f\n" +
	"\vvoting_term\x18\x02 \x01(\x03R\n" +
	"votingTerm\"O\n" +
	...
	"\x11remaining_reasons\x18\x02 \x01(\rR\x10remainingReasons\"\xa8\x01\n" +
	...
	"\x1fTRANSACTION_CONCLUSION_ROLLBACK\x10\x022\xfc\b\n" +
	...
	"\x0fCopyBidiExecute\x12*.multipoolerservice.CopyBidiExecuteRequest\x1a+.multipoolerservice.CopyBidiExecuteResponse(\x010\x01\x12u\n" +
	"\x12StreamPoolerHealth\x12-.multipoolerservice.StreamPoolerHealthRequest\x1a..multipoolerservice.StreamPoolerHealthResponse0\x01\x12{\n" +
...
var file_multipoolerservice_proto_goTypes = []any{
	...
	(*StreamPoolerHealthRequest)(nil),         // 16: multipoolerservice.StreamPoolerHealthRequest
	(*StreamPoolerHealthResponse)(nil),        // 17: multipoolerservice.StreamPoolerHealthResponse
	(*PrimaryObservation)(nil),                // 18: multipoolerservice.PrimaryObservation
	(*ReservationOptions)(nil),                // 19: multipoolerservice.ReservationOptions
	(*ReserveStreamExecuteRequest)(nil),       // 20: multipoolerservice.ReserveStreamExecuteRequest
	(*ReserveStreamExecuteResponse)(nil),      // 21: multipoolerservice.ReserveStreamExecuteResponse
	(*ConcludeTransactionRequest)(nil),        // 22: multipoolerservice.ConcludeTransactionRequest
	(*ConcludeTransactionResponse)(nil),       // 23: multipoolerservice.ConcludeTransactionResponse
	(*ReleaseReservedConnectionRequest)(nil),  // 24: multipoolerservice.ReleaseReservedConnectionRequest
	(*ReleaseReservedConnectionResponse)(nil), // 25: multipoolerservice.ReleaseReservedConnectionResponse
	...
	(*query.PreparedStatement)(nil),           // 30: query.PreparedStatement
	(*query.Portal)(nil),                      // 31: query.Portal
	(*query.QueryResultPayload)(nil),          // 32: query.QueryResultPayload
	(*clustermetadata.ID)(nil),                // 33: clustermetadata.ID
	(*query.StatementDescription)(nil),        // 34: query.StatementDescription
	(clustermetadata.PoolerServingStatus)(0),  // 35: clustermetadata.PoolerServingStatus
...
var file_multipoolerservice_proto_depIdxs = []int32{
	...
	26, // 4: multipoolerservice.StreamExecuteRequest.target:type_name -> query.Target
	27, // 5: multipoolerservice.StreamExecuteRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 6: multipoolerservice.StreamExecuteRequest.options:type_name -> query.ExecuteOptions
	29, // 7: multipoolerservice.StreamExecuteResponse.result:type_name -> query.QueryResult
	26, // 8: multipoolerservice.PortalStreamExecuteRequest.target:type_name -> query.Target
	30, // 9: multipoolerservice.PortalStreamExecuteRequest.prepared_statement:type_name -> query.PreparedStatement
	31, // 10: multipoolerservice.PortalStreamExecuteRequest.portal:type_name -> query.Portal
	27, // 11: multipoolerservice.PortalStreamExecuteRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 12: multipoolerservice.PortalStreamExecuteRequest.options:type_name -> query.ExecuteOptions
	32, // 13: multipoolerservice.PortalStreamExecuteResponse.result:type_name -> query.QueryResultPayload
	33, // 14: multipoolerservice.PortalStreamExecuteResponse.pooler_id:type_name -> clustermetadata.ID
	26, // 15: multipoolerservice.DescribeRequest.target:type_name -> query.Target
	30, // 16: multipoolerservice.DescribeRequest.prepared_statement:type_name -> query.PreparedStatement
	31, // 17: multipoolerservice.DescribeRequest.portal:type_name -> query.Portal
	27, // 18: multipoolerservice.DescribeRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 19: multipoolerservice.DescribeRequest.options:type_name -> query.ExecuteOptions
	34, // 20: multipoolerservice.DescribeResponse.description:type_name -> query.StatementDescription
	2,  // 21: multipoolerservice.CopyBidiExecuteRequest.phase:type_name -> multipoolerservice.CopyBidiExecuteRequest.Phase
	26, // 22: multipoolerservice.CopyBidiExecuteRequest.target:type_name -> query.Target
	27, // 23: multipoolerservice.CopyBidiExecuteRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 24: multipoolerservice.CopyBidiExecuteRequest.options:type_name -> query.ExecuteOptions
	3,  // 25: multipoolerservice.CopyBidiExecuteResponse.phase:type_name -> multipoolerservice.CopyBidiExecuteResponse.Phase
	33, // 26: multipoolerservice.CopyBidiExecuteResponse.pooler_id:type_name -> clustermetadata.ID
	29, // 27: multipoolerservice.CopyBidiExecuteResponse.result:type_name -> query.QueryResult
	26, // 28: multipoolerservice.StreamPoolerHealthResponse.target:type_name -> query.Target
	33, // 29: multipoolerservice.StreamPoolerHealthResponse.pooler_id:type_name -> clustermetadata.ID
	35, // 30: multipoolerservice.StreamPoolerHealthResponse.serving_status:type_name -> clustermetadata.PoolerServingStatus
	18, // 31: multipoolerservice.StreamPoolerHealthResponse.primary_observation:type_name -> multipoolerservice.PrimaryObservation
	36, // 32: multipoolerservice.StreamPoolerHealthResponse.recommended_staleness_timeout:type_name -> google.protobuf.Duration
	33, // 33: multipoolerservice.PrimaryObservation.primary_id:type_name -> clustermetadata.ID
	26, // 34: multipoolerservice.ReserveStreamExecuteRequest.target:type_name -> query.Target
	27, // 35: multipoolerservice.ReserveStreamExecuteRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 36: multipoolerservice.ReserveStreamExecuteRequest.options:type_name -> query.ExecuteOptions
	19, // 37: multipoolerservice.ReserveStreamExecuteRequest.reservation_options:type_name -> multipoolerservice.ReservationOptions
	29, // 38: multipoolerservice.ReserveStreamExecuteResponse.result:type_name -> query.QueryResult
	33, // 39: multipoolerservice.ReserveStreamExecuteResponse.pooler_id:type_name -> clustermetadata.ID
	26, // 40: multipoolerservice.ConcludeTransactionRequest.target:type_name -> query.Target
	27, // 41: multipoolerservice.ConcludeTransactionRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 42: multipoolerservice.ConcludeTransactionRequest.options:type_name -> query.ExecuteOptions
	1,  // 43: multipoolerservice.ConcludeTransactionRequest.conclusion:type_name -> multipoolerservice.TransactionConclusion
	29, // 44: multipoolerservice.ConcludeTransactionResponse.result:type_name -> query.QueryResult
	26, // 45: multipoolerservice.ReleaseReservedConnectionRequest.target:type_name -> query.Target
	27, // 46: multipoolerservice.ReleaseReservedConnectionRequest.caller_id:type_name -> mtrpc.CallerID
	28, // 47: multipoolerservice.ReleaseReservedConnectionRequest.options:type_name -> query.ExecuteOptions
	4,  // 48: multipoolerservice.MultiPoolerService.ExecuteQuery:input_type -> multipoolerservice.ExecuteQueryRequest
	6,  // 49: multipoolerservice.MultiPoolerService.StreamExecute:input_type -> multipoolerservice.StreamExecuteRequest
	8,  // 50: multipoolerservice.MultiPoolerService.PortalStreamExecute:input_type -> multipoolerservice.PortalStreamExecuteRequest
	10, // 51: multipoolerservice.MultiPoolerService.Describe:input_type -> multipoolerservice.DescribeRequest
	12, // 52: multipoolerservice.MultiPoolerService.GetAuthCredentials:input_type -> multipoolerservice.GetAuthCredentialsRequest
	14, // 53: multipoolerservice.MultiPoolerService.CopyBidiExecute:input_type -> multipoolerservice.CopyBidiExecuteRequest
	16, // 54: multipoolerservice.MultiPoolerService.StreamPoolerHealth:input_type -> multipoolerservice.StreamPoolerHealthRequest
	20, // 55: multipoolerservice.MultiPoolerService.ReserveStreamExecute:input_type -> multipoolerservice.ReserveStreamExecuteRequest
	22, // 56: multipoolerservice.MultiPoolerService.ConcludeTransaction:input_type -> multipoolerservice.ConcludeTransactionRequest
	24, // 57: multipoolerservice.MultiPoolerService.ReleaseReservedConnection:input_type -> multipoolerservice.ReleaseReservedConnectionRequest
	5,  // 58: multipoolerservice.MultiPoolerService.ExecuteQuery:output_type -> multipoolerservice.ExecuteQueryResponse
	32, // 59: multipoolerservice.MultiPoolerService.StreamExecute:output_type -> query.QueryResultPayload
	9,  // 60: multipoolerservice.MultiPoolerService.PortalStreamExecute:output_type -> multipoolerservice.PortalStreamExecuteResponse
	11, // 61: multipoolerservice.MultiPoolerService.Describe:output_type -> multipoolerservice.DescribeResponse
	13, // 62: multipoolerservice.MultiPoolerService.GetAuthCredentials:output_type -> multipoolerservice.GetAuthCredentialsResponse
	15, // 63: multipoolerservice.MultiPoolerService.CopyBidiExecute:output_type -> multipoolerservice.CopyBidiExecuteResponse
	17, // 64: multipoolerservice.MultiPoolerService.StreamPoolerHealth:output_type -> multipoolerservice.StreamPoolerHealthResponse
	21, // 65: multipoolerservice.MultiPoolerService.ReserveStreamExecute:output_type -> multipoolerservice.ReserveStreamExecuteResponse
	23, // 66: multipoolerservice.MultiPoolerService.ConcludeTransaction:output_type -> multipoolerservice.ConcludeTransactionResponse
	25, // 67: multipoolerservice.MultiPoolerService.ReleaseReservedConnection:output_type -> multipoolerservice.ReleaseReservedConnectionResponse
