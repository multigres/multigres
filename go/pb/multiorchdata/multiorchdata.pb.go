...
type PoolerHealthState struct {
	...
	// This is determined from the health check:
	// - true: Status RPC succeeded (postgres is running)
	// - false: Status RPC failed but InitializationStatus succeeded (postgres is down)
...
const file_multiorchdata_proto_rawDesc = "" +
	"\n" +
	"\x13multiorchdata.proto\x12\rmultiorchdata\x1a\x15clustermetadata.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cmultipoolermanagerdata.proto\"\x9a\x05\n" +
	...
	" \x01(\bR\x11isPostgresRunningB4Z2github.com/multigres/multigres/go/pb/multiorchdatab\x06proto3"
