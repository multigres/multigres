...
// GetCellNamesCommand represents the getcellnames command
var GetCellNamesCommand = &cobra.Command{
	Use:   "getcellnames",
...
func init() {
	GetCellNamesCommand.Flags().String("admin-server", "", "Address of the multiadmin server (overrides config)")
}
