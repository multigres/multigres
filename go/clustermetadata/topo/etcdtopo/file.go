...
func (s *etcdtopo) Create(ctx context.Context, filePath string, contents []byte) (topo.Version, error) {
...
func (s *etcdtopo) Update(ctx context.Context, filePath string, contents []byte, version topo.Version) (topo.Version, error) {
	nodePath := path.Join(s.root, filePath)
...
func (s *etcdtopo) Get(ctx context.Context, filePath string) ([]byte, topo.Version, error) {
	nodePath := path.Join(s.root, filePath)
...
func (s *etcdtopo) List(ctx context.Context, filePathPrefix string) ([]topo.KVInfo, error) {
...
func (s *etcdtopo) Delete(ctx context.Context, filePath string, version topo.Version) error {
	nodePath := path.Join(s.root, filePath)
